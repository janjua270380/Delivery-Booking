...
import { Truck, Database, User, Menu, X, Shield, LogIn, UserPlus, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-semibold text-gray-800">Distance Calculator</span>
          </div>
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-3">
                <button 
                  ...
                  className="flex items-center gap-1 text-sm py-1.5 px-3 bg-green-600 text-white hover:bg-green-700 rounded-md"
                >
