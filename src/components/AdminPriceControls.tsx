    ...
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      <div className="bg-gray-50 p-4 rounded-md">
        <div className="flex justify-between items-center">
          <div>
            <img 
              src="https://images.unsplash.com/photo-1501300140941-6c556d26c1b9?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxhZG1pbiUyMGRhc2hib2FyZCUyMHByaWNpbmclMjBjb250cm9sJTIwcGFuZWx8ZW58MHx8fHwxNzQzODA1ODk5fDA&ixlib=rb-4.0.3&fit=fillmax&h=500&w=800"
              alt="Dashboard pricing panel"
