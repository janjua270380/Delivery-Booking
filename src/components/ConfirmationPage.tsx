...
import { ArrowLeft, Zap, Calendar, Truck, AlertCircle, Bike, Clock, Mail, Phone, FileText, Scale } from 'lucide-react';
...
export function ConfirmationPage({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      {/* Vehicle type indicator with image */}
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <p className="font-medium text-blue-900">
              {vehicleType === 'bike' ? 'Bike Courier' : 'Van'}
              {vehicleType === 'van' && (
                <span className="block text-xs font-normal mt-1 flex items-center gap-1">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <div className="flex items-start gap-3">
            <div className="hidden md:block flex-shrink-0 w-1/4">
              <img 
                src="https://images.unsplash.com/photo-1734551330591-7534ffc05c17?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxjb3VyaWVyJTIwc2VydmljZSUyMGRlbGl2ZXJ5JTIwZHJpdmVyJTIwbm90ZXMlMjBjbGlwYm9hcmR8ZW58MHx8fHwxNzQzODgyNzUwfDA&ixlib=rb-4.0.3&fit=fillmax&h=300&w=400"
                alt="Delivery notes clipboard"
