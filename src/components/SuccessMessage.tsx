import  { CheckCircle, ArrowRight, Clock, Truck, Bike, AlertCircle, Scale } from 'lucide-react';
...
export function SuccessMessage({ onReset, bookingId, vehicleType }: SuccessMessageProps) {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 text-center">
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          Your collection booking has been submitted for approval. Booking ID: <span className="font-semibold">{bookingId}</span>
        </p>
