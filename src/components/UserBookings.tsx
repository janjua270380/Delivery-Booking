...
import { ArrowLeft, Clock, Eye, CheckCircle, AlertTriangle, XCircle, RefreshCw, Calendar, Bike, Truck, Info, Edit, MapPin, Search, ExternalLink } from 'lucide-react';
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredBookings.map((booking, index) => {
                  const isModifiable = booking.status === 'pending' && new Date() < new Date(booking.modifiableUntil);
                  ...
                  return (
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {getStatusBadge(booking.status, isModifiable)}
                        {isModifiable && (
